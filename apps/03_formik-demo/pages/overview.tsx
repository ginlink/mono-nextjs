...
import { generateSamplePassword, handleSubmit } from './utils'
        ...
        <Form>
          <div className={styles.container}>
            <div className={styles.componentContainer}>
              ...
              <Input addonBefore="city" name="address.city" placeholder="Input (nested object)" />
              ...
              <InputNumber name="dollars" formatter={(value: any) => `$ ${value}`} />
              <AutoComplete
                name="auto"
              ...
              <DatePicker name="date" showTime={true} placeholder="DatePicker" />
              <Radio.Group
                name="radioGroup"
                options={[
